...
export const GoogleButton = () => {
  return (
    <Button
      variant="outline"
      className="w-full flex items-center justify-center gap-3 h-12 bg-card hover:bg-muted"
    >
      ...
      <span className="text-foreground font-medium">Continue com o Google</span>
    </Button>
  );
};
